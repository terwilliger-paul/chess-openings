...
#
# ActiveState ActiveTcl 8.5.17.0.298612 Win32/x64, Sun Nov 09 10:56:01 PST 2014
#
...
namespace eval ::activestate {
	...
	product       {ActiveTcl}
	release       {8.5.17.0}
	tcl,revision  {bd09a69e14fb80cefce4c3b9e223264ad5148bed}
	tk,revision   {e526d6c474be050487096092ac6f559a0110ba2e}
	maturity      {final}
	arch          {win32-x64}
	buildtime,sec {1415559361}
	buildtime,fmt {Sun Nov 09 10:56:01 PST 2014}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.5.17.0.298612 Win32/x64 @ Sun Nov 09 10:56:01 PST 2014 bd09a69e14fb80cefce4c3b9e223264ad5148bed / normal}
    }
}

package provide {ActiveTcl} {8.5.17.0.298612}
